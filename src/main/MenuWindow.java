...
public class MenuWindow {
   ...
   * @param borderTxMap TxMap with all the border textures.
   *                    <br/><b>Map should contain the following keys & textures:</b>
   *                    <ul>
   ...
   * @see TxMap
   */
  public MenuWindow(int x, int y, int width, int upperHeight, int lowerHeight, @NotNull TxMap borderTxMap, double scale) {
    if (width < 0) {
    ...
    BufferedImage topLeftCorner = borderTxMap.getRelScaled(scale, "menuTopLeftCorner");
    BufferedImage topRightCorner = borderTxMap.getRelScaled(scale, "menuTopRightCorner");
    BufferedImage midLeftCorner = borderTxMap.getRelScaled(scale, "menuMidLeftCorner");
    BufferedImage midRightCorner = borderTxMap.getRelScaled(scale, "menuMidRightCorner");
    BufferedImage bottomLeftCorner = borderTxMap.getRelScaled(scale, "menuBottomLeftCorner");
    BufferedImage bottomRightCorner = borderTxMap.getRelScaled(scale, "menuBottomRightCorner");
    BufferedImage topEdge = borderTxMap.getRelScaled(1, scale, "menuTopEdge");
    BufferedImage midEdge = borderTxMap.getRelScaled(1, scale, "menuMidEdge");
    BufferedImage bottomEdge = borderTxMap.getRelScaled(1, scale, "menuBottomEdge");
    BufferedImage topLeftEdge = borderTxMap.getRelScaled(scale, 1, "menuTopLeftEdge");
    BufferedImage topRightEdge = borderTxMap.getRelScaled(scale, 1, "menuTopRightEdge");
    BufferedImage bottomLeftEdge = borderTxMap.getRelScaled(scale, 1, "menuBottomLeftEdge");
    BufferedImage bottomRightEdge = borderTxMap.getRelScaled(scale, 1, "menuBottomRightEdge");
