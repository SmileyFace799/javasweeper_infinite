...
public class MenuWindow {
     ...
     * @see TxMap
     */
    public MenuWindow(int width, int upperHeight, int lowerHeight, double scale) {
        if (width < 0) {
        ...
        boundingRect = new Rectangle(0, 0, fullWidth, fullHeight);
        upperRect = new Rectangle(
                topLeftCorner.getWidth(), topLeftCorner.getHeight(),
                width, upperHeight
        );
        lowerRect = new Rectangle(topLeftCorner.getWidth(),
                topLeftCorner.getHeight() + upperHeight + midLeftCorner.getHeight(),
                width, lowerHeight
        );
    }
