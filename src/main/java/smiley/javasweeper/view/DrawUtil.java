...
public class DrawUtil {
     ...
     *
     * @param g  The graphics object to draw the string on
     * @param str The string to draw
     * @param y   The y-coordinate for the string's baseline
     */
    public static void drawStringCenteredX(@NotNull Graphics g, String str, int y, int width) {
        g.drawString(str, getCenteredX(width, g.getFontMetrics().stringWidth(str)), y);
    }

    public static void drawStringCenteredX(@NotNull Graphics g, String str, int y) {
        drawStringCenteredX(g, str, y, GraphicManager.getInstance().getWindowWidth());
    }

    public static void drawStringCentered(@NotNull Graphics g, String str, int width, int height) {
        int fontHeight = g.getFont().getSize();
        drawStringCenteredX(g, str, getCenteredY(height, fontHeight) + fontHeight, width);
    }

    public static void drawStringCentered(@NotNull Graphics g, String str) {
        drawStringCentered(
                g, str,
